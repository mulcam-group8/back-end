...
public class FindInfoController {
	...
	public String mailsend(String id, String name, String email,HttpServletRequest request) throws AddressException, MessagingException, UnsupportedEncodingException {
		...
		String subject = "[Charcha]임시 비밀번호가 발급되었습니다.";
		String body = "<h2>안녕하세요 " + name + "님</h2><br><br>"
				+ "<p>비밀번호 찾기를 요청해주셔서 임시 비밀번호 발급해드렸습니다.</p>"
				+ "<p>임시로 발급해 드린 비밀번호는 <h2 style='color : blue'>" + randompw 
				+ "</h2>이며 로그인 후에 마이페이지에서 비밀번호를 변경해주시길 바랍니다.</p><br><br>"
				+ "<a href='http://localhost:8080/charcha/>홈페이지 접속</a>";
